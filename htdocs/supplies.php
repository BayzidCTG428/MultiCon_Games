...
<head>
    ...
    <link rel="stylesheet" href="stylesupplies.css">
...
<div class="supplies-container">
    ...
    <!-- Insert form -->
    <h3>Insert Data</h3>
    <form  action="insertsupplies.php" method="post">   
        ...
        <div>
            <label for="sup_id">Supplier's ID:</label>
    ...
    <!-- Update form -->
    <h3>Update Data</h3>
    <form action="updatesupplies.php" method="post">
    ...
    <!-- Delete form -->
    <h3>Delete Data</h3>
    <form action="deletesupplies.php" method="post">
        <label for="pro_id">Product ID:</label>
        <input type="text" id="pro_id" name="pro_id" required>
